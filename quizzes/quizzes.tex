...
\begin{checkboxes}
\CorrectChoice Always to peer P5
\choice Either to peer P5 or P6
\choice Either to peer P3, P4, P5 or P6
\end{checkboxes}
...
\choice When a query answer message arrives
...
\choice Low clustering and low diameter
...
\choice The time a client listens actively on a broadcast
channel
